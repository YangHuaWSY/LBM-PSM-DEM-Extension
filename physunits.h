...
namespace plb {
  ...
  public:
    ...
    T getLbNu(T const physNu) const {return physNu * (t_p/l_p/l_p) * param.getDeltaT()/param.getDeltaX()/param.getDeltaX();};
    ...
    T getPhysNu(T const lbNu) const {return lbNu * l_p*l_p/t_p * param.getDeltaX()*param.getDeltaX()/param.getDeltaT();};
